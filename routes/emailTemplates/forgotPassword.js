function forgotPassword(information) {
    const { name, resetUrl } = information;
    ...
    <p style="font-size: 16px; line-height: 1.2; word-break: break-word; text-align: center; font-family: 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif; mso-line-height-alt: 19px; margin: 0;"><span style="font-size: 16px;">Hello ${name},</span><br/><span style="font-size: 15px;"> You are receiving this email because you have requested your password reset. Please visit the below link to reset your password.</span></p>
    <p style="font-size: 14px; line-height: 1.2; word-break: break-word; text-align: center; font-family: 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif; mso-line-height-alt: 17px; margin: 0;"><strong><span style="font-size: 15px;">Do not share this link with anybody. This link is valid only for 10 minutes.</span></strong><br/><br/></p>
    </div>
    </div>
    <!--[if mso]></td></tr></table><![endif]-->
    <div align="center" class="button-container" style="padding-top:15px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
    <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"><tr><td style="padding-top: 15px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px" align="center"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href=${resetUrl} style="height:31.5pt; width:152.25pt; v-text-anchor:middle;" arcsize="10%" stroke="false" fillcolor="#2e5833"><w:anchorlock/><v:textbox inset="0,0,0,0"><center style="color:#ffffff; font-family:'Trebuchet MS', Tahoma, sans-serif; font-size:12px"><![endif]--><a href=${resetUrl} style="-webkit-text-size-adjust: none; text-decoration: none; display: inline-block; color: #ffffff; background-color: #2e5833; border-radius: 4px; -webkit-border-radius: 4px; -moz-border-radius: 4px; width: auto; width: auto; border-top: 1px solid #2e5833; border-right: 1px solid #2e5833; border-bottom: 1px solid #2e5833; border-left: 1px solid #2e5833; padding-top: 5px; padding-bottom: 5px; font-family: 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif; text-align: center; mso-border-alt: none; word-break: keep-all;" target="_blank"><span style="padding-left:20px;padding-right:20px;font-size:12px;display:inline-block;"><span style="line-height: 24px; word-break: break-word;">RESET PASSWORD</span></span></a>
    ...
    <div align="center" class="img-container center fixedwidth" style="padding-right: 0px;padding-left: 0px;">
    <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px"><td style="padding-right: 0px;padding-left: 0px;" align="center"><![endif]--><a href=${resetUrl} style="outline:none" tabindex="-1" target="_blank"> <img align="center" alt="Farmgate Logo" border="0" class="center fixedwidth" src="https://res.cloudinary.com/dtgqjl09r/image/upload/v1594642115/logo_c7895g_d9srci.png" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: 5rem; border: 0; width: 5.2rem; max-width: 224px; display: block;" title="Farmgate Logo" width="224"/></a>
    <!--[if mso]></td></tr></table><![endif]-->
    </div>
    <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px; font-family: serif"><![endif]-->
    <div style="color:#555555;font-family:'Merriwheater', 'Georgia', serif;line-height:1.2;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
