function invoiceShop(information) {
  ...
  return `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
    ...
    <p style="font-size: 16px; line-height: 1.2; word-break: break-word; text-align: center; font-family: 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif; mso-line-height-alt: 19px; margin: 0;"><span style="font-size: 16px;">Please find the attached invoice of $${total} that has been generated for you on Farmgate Market.</span></p>
    </div>
    </div>
    <!--[if mso]></td></tr></table><![endif]-->
