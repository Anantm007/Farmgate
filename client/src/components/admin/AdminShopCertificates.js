    ...
    return (
        <Fragment>
            ...
            <div style={{margin: "2rem", padding: "1rem"}}>
                <Link to={`/admin/shops/${_id}/add/certificate`}><button className="btn btn-primary">+ ADD CERTIFICATE</button></Link>
            </div>
            ...
            <div className="xs-col-12 col-sm-8">                
                {certificates.map((certificate, index) => {
                    return (
                        <div key={index} className="mt-5" style={{margin: "2rem", border: "0.5px solid"}}>
                            <ul className="list-group mb-2">
                                <li className="list-group-item" ><strong>Certificate Name:</strong> {certificate.name}</li>
                                ...
                                <div className="row">
                                    <div className="xs-col-12 col-lg=6" style={{margin: "2rem"}}>
                                        <Link to={`/admin/shops/${_id}/certificate/${certificate._id}`}><button className="btn btn-primary">UPDATE</button></Link>
