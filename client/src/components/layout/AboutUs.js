        ...
        <Fragment>
            ...
            <div className="container py-5">
                ...
                <div className="col-lg-6">
                    ...
                    <p className="lead text-muted mb-0">Trading as Farmgate Ag, we are an IT company from farming grass roots, with a passion for quality food, and supporting healthy physiology!</p><br/>
                    <p className="lead text-muted mb-0">We provide a service to deliver produce from the farm gate to the consumer door step.</p><br/>
