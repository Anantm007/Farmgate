        ...
        <Fragment>
            ...
            <div className="container py-5">
                ...
                <div className="col-lg-6">
                    ...
                    <p className="lead text-muted mb-0">Trading as Farmgate Ag, we are Produce Traders with a passion for quality food! We provide a service to deliver produce from the farm gate to the consumer door step.</p><br/>
