  ...
  return (
    <Router>
      ...
      <Switch>
        ...
        <ShopRoute
          exact
          path="/shop/:id/add/certificate"
          component={AddCertificate}
        />
        <ShopRoute
          exact
          path="/shop/:id/certificates"
          component={ShopCertificates}
        />
        <ShopRoute
          exact
          path="/shop/:id/certificate/:certificateId"
        ...
        <AdminRoute
          exact
          path="/admin/update/item/:itemid"
          component={UpdateItem}
        />
        <AdminRoute
          exact
          path="/admin/shops/:id/certificates"
          component={AdminShopCertificates}
        />
        <AdminRoute
          exact
          path="/admin/shops/:id/add/certificate"
          component={AdminAddCertificate}
        />
        <AdminRoute
          exact
          path="/admin/shops/:id/certificate/:certificateId"
          component={AdminEditCertificate}
        />
